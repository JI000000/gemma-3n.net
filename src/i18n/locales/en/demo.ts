export const demo = {
  ...
  // 多模态输入相关
  'demo.input.type.label': 'Input Type',
  'demo.input.type.text': 'Text',
  'demo.input.type.image': 'Image',
  'demo.input.type.audio': 'Audio',
  'demo.input.text.label': 'Text Input',
  'demo.input.text.placeholder': 'Enter your text, code, or question...',
  'demo.input.text.placeholder.code': 'Enter your code or programming question...',
  'demo.input.text.placeholder.translate': 'Enter text to translate...',
  'demo.input.text.placeholder.chat': 'Ask me anything...',
  'demo.input.image.label': 'Image Input',
  'demo.input.image.drag_drop': 'Drag and drop an image here',
  'demo.input.image.or_click': 'or click to browse',
  'demo.input.image.remove': 'Remove Image',
  'demo.input.audio.label': 'Audio Input',
  'demo.input.audio.record': 'Start Recording',
  'demo.input.audio.stop': 'Stop',
  'demo.input.audio.play': 'Play',
  'demo.input.audio.or_upload': 'Or upload an audio file:',
  
  // 模型选择
  'demo.model.label': 'Model Selection',
  
  // API配置相关
  'demo.api.config': 'API Config',
  'demo.api.title': 'API Configuration',
  'demo.api.provider': 'API Provider',
  'demo.api.huggingface': 'Hugging Face',
  'demo.api.ollama': 'Ollama (Local)',
  'demo.api.custom': 'Custom API',
  'demo.api.endpoint': 'API Endpoint',
  'demo.api.key': 'API Key',
  'demo.api.key_help': 'Optional for public models, required for private models',
  'demo.api.model': 'Model',
  'demo.api.test': 'Test Connection',
  'demo.api.save': 'Save Configuration',
  'demo.api.reset': 'Reset to Defaults',
  'demo.api.test_success': '✅ Connection successful!',
  'demo.api.test_failed': '❌ Connection failed',
  'demo.api.save_success': '✅ Configuration saved successfully!',
  'demo.api.save_failed': '❌ Failed to save configuration',
  // API status banner
  'demo.api.status.connected': '✅ API Connected - Real AI inference available',
  'demo.api.status.fallback': '⚠️ Using simulation mode - Configure API for real inference',
  'demo.api.status.error': '❌ API Error - Check configuration',
  'demo.api.status.checking': 'Checking API status...',
  ...
  'demo.info.prod.feature5': 'Complete Image Analysis Functionality',
  'demo.info.prod.feature6': 'Speech-to-Text Conversion',
  'demo.info.prod.feature7': 'Advanced Parameter Tuning',
  'demo.info.prod.feature8': 'User Session Management',
